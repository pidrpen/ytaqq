...
Фея чуть крупнее прочих: программа загружает её в 1,25 размера системного
курсора, поэтому здесь рисуются 40, 50 и 60 точек (масштаб экрана 100, 125
и 150 %) — ровно под эти размеры, без размытия от сжатия. (До 2026.09.23.13
было полтора размера, 48 и 72 точки, — оказалось крупно.)
"""
